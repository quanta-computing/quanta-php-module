...
zend_execute_data *execute_data) {
  ...
  || !(entity = get_mage_model_data(Z_OBJPROP_P(this), "indexer_code"))
...
zend_execute_data *execute_data) {
  ...
  || !(type = get_mage_model_data(Z_OBJPROP_P(event), "entity"))
  || !(entity = get_mage_model_data(Z_OBJPROP_P(event), "type"))
