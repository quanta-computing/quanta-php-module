...
{"Mage::run", 0, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Model_App::_initBaseConfig", 1, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Model_App::_initCache", 2, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Model_Config::loadModulesCache", 3, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Model_Config::loadModules", 4, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Model_Resource_Setup::applyAllUpdates", 5, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Model_Config::loadDb", 6, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Model_App::_initStores", 7, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Controller_Varien_Action::preDispatch", 8, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Controller_Varien_Action::loadLayoutUpdates", 9, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Controller_Varien_Action::renderLayout", 10, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Controller_Varien_Action::postDispatch", 11, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Controller_Response_Http::sendResponse", 12, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Block_Abstract::toHtml", 13, {1, 0}, magento1_block_before_render, magento_block_after_render, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Model_Cache::flush", 14, {1, 0}, magento_record_cache_flush_event, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Adminhtml_CacheController::flushSystemAction", 15, {1, 0}, magento_record_cache_system_flush_event, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Core_Model_Cache::cleanType", 16, {1, 0}, magento1_record_cache_clean_event, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"Mage_Index_Model_Event::_beforeSave", 17, {1, 0}, NULL, magento1_record_reindex_event, {0, 0, 0, 0}, {0, 0, 0, 0}},
{"PDOStatement::execute", 18, {1, 0}, NULL, magento_record_sql_query, {0, 0, 0, 0}, {0, 0, 0, 0}},
{NULL, 0, {0, 0}, NULL, NULL, {0, 0, 0, 0}, {0, 0, 0, 0}}
};
...
static const profiler_timer_t magento_profiler_timers[] = {
{
  ...
  {&magento_profiled_functions[1], PROF_FIRST_START},
  {0}
},
{
  "init_config",
...
},
{
  "total",
  {&magento_profiled_functions[0], PROF_FIRST_START},
  {&magento_profiled_functions[0], PROF_LAST_STOP},
  {1}
},
{NULL, {0, 0}, {0, 0}, {0}}
};
       ...
       if (function_name[6] == 'e') {
        if (function_name[7] == 'S') {
         if (function_name[8] == 'a') {
          if (function_name[9] == 'v') {
           if (function_name[10] == 'e') {
            if (function_name[11] == '\0') {
             ++hp_globals.internal_match_counters.function;
             const char *class_name = hp_get_class_name(data TSRMLS_CC);
             if (!class_name) return NULL;
             if (!strcmp(class_name, "Mage_Index_Model_Event"))
